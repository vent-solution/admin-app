...
import { businessType } from "../enums/businessTypeEnum";
...
export const BUSINESS_TYPE_DATA: { label: string; value: string }[] = [
  { label: "Rent units", value: businessType.rent },
  { label: "Rent whole facility", value: businessType.rentWhole },
  { label: "Sale whole facility", value: businessType.sale },
  { label: "Sale condominiums", value: businessType.saleCondominium },
  { label: "Hospitality", value: businessType.hospitality },
  { label: "Others", value: businessType.others },
];
